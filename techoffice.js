...
function techOffice (key){
    ...
    /**
     * Return the values of a counter sensor
     * @param {*} response Response of ajax request.
     */
    ...
    /**
     * Return the value of the data and timestamp
     *  @param {*} response 
     */
